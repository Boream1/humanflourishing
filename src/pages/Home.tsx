      ...
      <div className="w-1/2 h-full flex flex-col justify-between p-8 md:p-16">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="max-w-md">
            ...
            <div className="border-l-4 border-red-500 pl-4 py-2 mb-8">
            ...
            <Button asChild className="mt-6 bg-red-400 hover:bg-red-500 text-white rounded-md px-6 py-4 md:px-8 md:py-6">
