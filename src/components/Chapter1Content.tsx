  ...
  return (
    <>
      <section className="chapter-header">
        <h1 className="chapter-title">LESSON 1: Being Human</h1>
      </section>
      ...
      <section className="chapter-body">
        <article className="lesson-content">
          ...
          <VideoSection
            ...
            videoId="video-1-1"
            videoSource="videos/w1v01-what-does-it-mean-to-be-human.mp4"
          ...
          <ReadingSection
            title="Readings"
            introduction="Please complete the readings below to engage with the following activities:"
            links={readings}
          />
          ...
          <ReadingSection
            ...
            introduction="Please complete the following readings if they are of interest to you!"
